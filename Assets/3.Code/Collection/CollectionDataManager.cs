...
public class CollectionDataManager : Singleton<CollectionDataManager>
{
    ...
    private List<string> myWordNameList = new List<string> { "가톨릭", "경제", "교육" };
    ...
    //private void Init()
    //{
    //    foreach(var value in myWordNameDict.Values)
    //    {
    //        List<Dictionary<string, object>> tempKey = CSVReader.Read($"Word/{value}");
